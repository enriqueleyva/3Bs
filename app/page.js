  ...
  return (
    <main className="container">
      <div className="card">
        ...
        <p className="p">
          Escribe un producto (con autocompletado) y presiona <b>Registrar</b> para
          enviarlo a tu Google Apps Script.
        </p>
        ...
        {lastSent ? (
          ...
          <div className="small">
            Nota: puedes permitir cualquier texto o validar que el producto exista
            en tu lista. (Ahorita se envía tal cual lo escribas.)
          </div>
        )}
      </div>

      <div className="small" style={{ marginTop: 14 }}>
        Consejo: si tu Apps Script no permite CORS, revisa el snippet en el README.
      </div>
    </main>
  );
}
